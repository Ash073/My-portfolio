...
export default function SplashCursor({
  ...
  useEffect(() => {
    ...
    function getWebGLContext(canvas: HTMLCanvasElement) {
      ...
      let formatRGBA: { internalFormat: number; format: number; type: number } | null;
      let formatRG: { internalFormat: number; format: number; type: number } | null;
      let formatR: { internalFormat: number; format: number; type: number } | null;
