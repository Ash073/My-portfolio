...
export default function RadialOrbitalTimeline({
  ...
  const calculateNodePosition = (index: number, total: number) => {
    ...
    const radius = 180; // Reduced radius for better visibility
  ...
  return (
    ...
    >
      <div className="relative w-full max-w-4xl h-full flex items-center justify-center" style={{ minHeight: '600px' }}>
        <div
        ...
        >
          ...
          <div className="absolute w-96 h-96 rounded-full border border-white/20" style={{ zIndex: 1 }}></div>
              ...
              >
                ...
                `}
                  style={{ 
                    ...
                    zIndex: isExpanded ? 201 : position.zIndex + 1
                  }}
                >
                  {item.title}
                </div>
